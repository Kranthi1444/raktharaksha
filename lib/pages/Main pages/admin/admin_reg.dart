...
class AdminDonorRegistrationPage extends StatefulWidget {
  const AdminDonorRegistrationPage({super.key});

  @override
  State<AdminDonorRegistrationPage> createState() => _AdminDonorRegistrationPageState();
}

class _AdminDonorRegistrationPageState extends State<AdminDonorRegistrationPage> {
  ...
  Future<void> registerDonor() async {
    ...
    try {
      await supabase.from('donors').insert({
        ...
        'email': _emailController.text.trim(), // ✅ Admin enters email
        'verified': false,
      });
      ...
      body: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              Text(
                "Enter Donor Details (Admin Only)",
